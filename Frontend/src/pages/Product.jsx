    ...
    <div className='border-t-2 border-gray-300 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <hr className='mt-5 sm:w-4/5 text-gray-200' />
          <div className='text-sm border-gray-500 mt-5 flex flex-col gap-1'>
      ...
      <div className='mt-20'>
        <div className='flex'>
          <b className='border border-gray-300 px-5 py-3 text-sm'>Desciption</b>
          <p className='border border-gray-300 px-5 py-3 text-sm'>Reviews (100)</p>
        </div>
        <div className='flex flex-col gap-4 border border-gray-200 px-6 py-6 text-sm text-gray-500'>
          ...
          <p>E-commerce websites typically offer a wide range of products, secure payment options, and efficient delivery systems to provide a seamless shopping experience for customers.</p>
        </div>
      </div>
