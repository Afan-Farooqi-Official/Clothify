    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-20'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>789 Commerce Plaza<br />New York, NY 10001, United States</p>
          <p className='text-gray-500'>Tel: +92-3132354990 <br /> Email: affanqaisar000@gmail.com</p>
          <p className='font-semibold text-xl text-gray-600'>Carrers at Clothify</p>
